...
public class Library {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (choose) {
                case 1:                                                                // AUTHOR
                    showAuthor(sc, authorClass, bookClass);
                    break;
                case 2:                                                                   // BOOK
                    ...
                    showBook(sc, authorClass, bookClass);
                    break;
                default:
            }
        } while (choose != 3);
    ...
    static void showAuthor(Scanner sc, AuthorClass authorClass, BookClass bookClass) {
    ...
    static void showBook(Scanner sc, AuthorClass authorClass, BookClass bookClass) {
        ...
        do {
            ...
            switch (choose) {
                ...
                case 5:
                    ...
                    if (bookClass.findId(idAuthorUpdate) != -1) {
